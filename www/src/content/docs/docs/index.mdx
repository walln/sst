...
Just like the frontend, you can configure backend features _in code_. Like Postgres, Redis, S3 Buckets, cron jobs, or your API deployed in container.
...
Alternatively, you can use SST in a monorepo. This is useful if you have a backend and a frontend or you are working on a large project. In this case the `sst.config.ts` is in the root of your monorepo.

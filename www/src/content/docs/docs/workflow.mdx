...
<VideoAside title="Watch a video about the SST Workflow" href="https://www.youtube.com/watch?v=QWORakXKw-o" />
...
:::note
The `sst dev` CLI deploys your app a little differently for local dev.
:::

...
import nextApp from "../../../../../assets/docs/start/openauth-nextjs.png"
...
:::tip[View source]
You can [view the source](https://github.com/sst/sst/tree/dev/examples/aws-auth-nextjs) of this example in our repo.
:::
...
<Image src={nextApp} alt="Next.js app login with OpenAuth" />

...
This will allow us to reference the Redis cluster in our Hono app.
...
This will deploy your app, start a tunnel in the **Tunnel** tab, and run your Hono app locally in the **MyServiceDev** tab.

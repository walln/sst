...
new sst.aws.Nextjs("MyWeb", {
  domain: "example.com" # or "app.example.com"
});
```
...
To get your API tokens, head to the [API Tokens section of your Cloudflare dashboard](https://dash.cloudflare.com/profile/api-tokens) and create one with _Edit zone DNS_ policy.

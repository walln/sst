...
4. What about PR stages?
  ...
  A stage has to be around for at least 2 weeks before it's counted as active. So if a PR stage is created and removed within 2 weeks, its resources are not counted.
